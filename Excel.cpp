...
void     cExcel::Range_PasteSpecial  (Variant Range)
{
if (!Range.intVal){return;}
Range.OleProcedure("PasteSpecial",13,-4142,false,false);
Range.OleProcedure("PasteSpecial",8,-4142,false,false);
Range.OleProcedure("PasteSpecial",-4122,-4142,false,false);
...
void     cExcel::Range_Color         (Variant Range,int ColorIndex)
{
	if (!Range.intVal)
		return;
    Range.OlePropertyGet("Interior").OlePropertySet("ColorIndex",ColorIndex);
}
